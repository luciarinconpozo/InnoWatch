...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $url . "/../assets/styles/register.css"?>">
    <link rel="stylesheet" href="<?php echo $url . "/../assets/styles/login.css"?>">
</head>
<body>
    <nav class="navbar navbar-expand-lg bg-marian-blue">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="nav-item">
                    <a href="<?php echo $url . "/../public/login.php"?>" class="btn btn-outline-vivid-sky-blue">Login</a>
                </li>
                <br>
                <li class="nav-item">
